...
##STEP 5: For each Orthology group selected in the STEP 3 extract the amino acid and DNA sequences
...
##STEP 6: simplifies the header of the CDS and amino acid fasta file
	perl ./Code/APS9_HeaderDictionary_pepCDS.pl ./Orthology_Groups/$L/$L.list.pep.fasta ./Orthology_Groups/$L/$L.list.cds.fasta
##STEP 7: Peptide alignment performed by PRANK
  	prank -d=./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa -o=./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa
##STEP 8: Peptide alignment performed by PRANK in nexus format plus phylogenetic tree in nexus format
 	prank -d=./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa -o=./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa -f=nexus
##STEP 9: Rename and reformat nexus phylogenetic tree of STEP 9
 	perl ./Code/APS10_CleanNex_nex.pl ./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa.best.nex
##STEP 10: Run pal2nal
 	../Code/pal2nal.v14/pal2nal.pl ./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa.best.fas ./Orthology_Groups/$L/$L.list.cds.fasta.dict.fa -output fasta > ./Orthology_Groups/$L/$L.codonalign.fasta
##STEP 11: tree labelling according to branches
 	perl ./Code/APS11_bestSequencesForATree.pl ./Orthology_Groups/$L/$L.list.pep.fasta.dict.fa.best.nex.cl.head.dnd
##STEP 12: Generate parameter files for Site models
	perl ./Code/APS12_CreateCtl_ParameterDefParPG_M0.pl ./Data/Parameter_codeml_M0.txt ./Data/Default_par.txt $L
	mv codeml$L.M0.ctl ./Orthology_Groups/$L/.
	perl ./Code/APS13_CreateCtl_ParameterDefParPG_SM.pl ./Data/Parameter_codeml_SM.txt ./Data/Default_par.txt $L
	mv codeml$L.sm.ctl ./Orthology_Groups/$L/.
	perl ./Code/APS14_CreateCtl_ParameterDefParPG_SM8.pl ./Data/Parameter_codeml_SM8.txt ./Data/Default_par.txt $L
...
##STEP 14: Quality control of the output from CODEML
...
cd ../
#STEP 16:  calculation of LRT (log ratio tests)
