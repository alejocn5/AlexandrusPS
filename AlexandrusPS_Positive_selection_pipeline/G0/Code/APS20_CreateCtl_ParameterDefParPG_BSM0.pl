...
#celegans_31_.BranchAnalyTree
my $Orthology_group = "$ARGV[2]";
my $Tree = $Orthology_group;
$Orthology_group =~ s/(.*)(.BranchAnalyTree)/$1/g;
my $Seq = $Orthology_group;
$Seq =~ s/(.*)(\_)(.*)(\_)/$2$3$4/g;



open my $OutGenTree, "> codeml\_$Orthology_group.bsm0.ctl";
...
print $OutGenTree "\tseqfile \= $Seq.codonalign.fasta\n";
#     treefile = _1_.pep.fa.dict.SpeciesTree.nex
print $OutGenTree "\ttreefile \= $Tree\n";
#      outfile = _1_.mlc
print $OutGenTree "\toutfile \= $Orthology_group.bsm0.mlc\n\n";
#	noisy = 9 
